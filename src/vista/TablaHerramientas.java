...
public class TablaHerramientas extends javax.swing.JDialog {
    ...
    /**
     * Creates new form TablaHerramientas
     */
    public TablaHerramientas(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void inicializarTablaProductos(int idCategoria) {
        ...
        try (PreparedStatement statement = conexion.prepareStatement(sql)) {
            ...
            try (ResultSet resultSet = statement.executeQuery()) {
                DefaultTableModel model = (DefaultTableModel) tblHerramientas.getModel();
    ...
    private void initComponents() {
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 90, 760, 390));
        ...
        jPanel2.add(btnSalir, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 400, 80, 40));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TablaHerramientas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TablaHerramientas dialog = new TablaHerramientas(new javax.swing.JFrame(), true);
